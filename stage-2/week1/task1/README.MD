...
#### 2. penggunaan server dan implementasi ssh-key:
...
#### 3. Clone Repository wayshub-frontend dan melakukan deploy aplikasi menggunakan PM2:
...
#### 4. konfigurasi reverse proxy serta implementasi penggunaan domain melalui cloudflare:
