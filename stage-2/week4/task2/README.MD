...
#### 4. melakukan konfigurasi reverse proxy untuk persiapan container monitoring di server gateway
...
#### 7. melakukan konfigurasi reverse proxy untuk persiapan container aplikasi frontend di server app-server
